...
const paths = [
  {
    ...
    body: "Camps are free, hands-on, and built for grades 4 through 8. Fall 2026 runs four connected weekly sessions, split into two grade tracks. Dates and registration are coming soon, so check the Fall page or follow us for updates.",
